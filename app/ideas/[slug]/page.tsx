...
const posts: BlogPost[] = [
  ...
  content: (
    <>
      ...
      <br /><br />
      I knew you could use AI to code, but having no coding background, I assumed it was just for small tweaks and not launching entire websites. But after watching Amjad's, and with my 2025 mantra, "you can just do things" in mind, I decided to give it a go.
      <br /><br />
